...
public class DesktopShoppingStress extends LetvTestCase{
    ...
    public void SeekShop()throws UiObjectNotFoundException,RemoteException{
        ...
        UiObject2 E = phone.findObject(By.clazz("android.widget.TextView").text("E"));
        UiObject2 S = phone.findObject(By.clazz("android.widget.TextView").text("S"));
        UiObject2 H = phone.findObject(By.clazz("android.widget.TextView").text("H"));
        UiObject2 I = phone.findObject(By.clazz("android.widget.TextView").text("I"));
        ...
        W.click();W.click();
        sleepInt(3);
        UiObject2 leshiwu=waitForObj(By.text(Pattern.compile("乐视无线游戏手柄 尚酷版 黑色")));
        leshiwu.click();
        leshiwu.click();
        sleepInt(3);
